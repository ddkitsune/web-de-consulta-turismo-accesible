...
// Nueva función de Voz para Textos Exactos desde la Base de Datos
function playSpecificVoice(text) {
    if (!text) return;
    ...
    utterance.lang = lang === 'es' ? 'es-ES' : 'en-US';
    utterance.rate = 0.9; // Velocidad pausada para mejor compresión
    utterance.pitch = 0.9; // Tono ligeramente más grave (suele ser más agradable)
